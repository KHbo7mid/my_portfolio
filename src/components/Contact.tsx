...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'khiari.ahmed2002@gmail.com',
      href: 'mailto:khiari.ahmed2002@gmail.com'
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+216 29780141',
      href: 'tel:+21629780141'
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Menzel Temime,Nabeul, Tunisia',
      href: null
    }
  ];
  ...
  <p className="text-gray-300 mb-8 leading-relaxed">
    ...
    I'm always eager to learn, collaborate, and take on exciting challenges. 
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center text-gray-400 ${social.color} transition-all duration-200`}
                  >
                    <social.icon size={20} />
                  </motion.a>
                ))}
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2"
              >
                {isSubmitting ? (
                  <>
